...
public class UndoRedo {
    ...
    public void undo() {
        if (undoStack.isEmpty()) {
            ...
            String command = undoStack.pop();   // Keluarkan dari undoStack
            redoStack.push(command);            // Masukkan ke redoStack
    ...
    public void redo() {
        if (redoStack.isEmpty()) {
            ...
            String command = redoStack.pop();   // Keluarkan dari redoStack
            undoStack.push(command);            // Masukkan ke undoStack
